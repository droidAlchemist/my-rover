...
# colcon build --packages-select cartographer costmap_converter_msgs costmap_converter emcl2 explore_lite openslam_gmapping slam_gmapping robot_pose_publisher teb_msgs teb_local_planner ugv_base_node ugv_interface
colcon build --packages-select robot_pose_publisher ugv_base_node ugv_interface
