...
colcon build --packages-select emcl2 explore_lite openslam_gmapping slam_gmapping robot_pose_publisher teb_msgs teb_local_planner ugv_base_node ugv_interface
