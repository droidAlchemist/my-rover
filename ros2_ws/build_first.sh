...
colcon build --packages-select iot_controller ugv_bringup ugv_chat_ai ugv_description ugv_gazebo ugv_nav ugv_slam ugv_tools ugv_vision ugv_web_app --symlink-install 
echo "source /home/joshua/my-rover/ros2_ws/install/setup.bash" >> ~/.bashrc
source ~/.bashrc 